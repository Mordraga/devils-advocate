...
function swayLine() {
  ...
  // No movement but a winner: the majority decided.
  if (Math.abs(sway) < 0.005) return `Chat held steady at ${Math.round((isA ? r.closingA : r.closingB) * 10) / 10}% - the majority decides`;
